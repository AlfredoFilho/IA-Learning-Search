...
def fill_dot(a_list, color, images):
    ...
    im = Image.open("GifMaker/ImagemTemp.png").convert("RGBA")
    ...
    im.save("GifMaker/ImagemTemp.png", 'PNG')
...
def fill(a_list, color, images):
    ...
    im = Image.open("GifMaker/ImagemTemp2.png").convert("RGBA")
    draw = ImageDraw.Draw(im)
 
    if color == "purple":
        font_path = "GifMaker/font.ttf"
    ...
    im.save("GifMaker/ImagemTemp.png", 'PNG')
    im.save("GifMaker/ImagemTemp2.png", 'PNG')
...
def compute_initial_image(cat, bloqueados, saida, images) :
    ...
    im = Image.open("GifMaker/ImagemTabuleiro.png").convert("RGBA")
    draw = ImageDraw.Draw(im)
