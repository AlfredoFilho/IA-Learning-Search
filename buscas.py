...
# FRAME DE DESENVOLVEDORES
frameDesenvolvedores = tk.LabelFrame(root, font=("Helvetica", 14), text="Desenvolvedores", borderwidth=2, foreground='orange', relief=tk.SUNKEN, bg=backgroundColor, width=270, height=100, padx=10, pady=5)
frameDesenvolvedores.place(x=1000, y=70)
